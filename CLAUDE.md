...
| `performance_monitor` | 性能监控 - Windows/Linux 设备性能采集、实时曲线图、版本对比 |
...
alembic upgrade head
python scripts/init_all_menus.py        # 初始化性能监控菜单
python scripts/init_metric_mappings.py  # 初始化 HWiNFO 指标映射
python scripts/init_linux_metric_mapping.py  # 初始化 Linux 指标映射
```
